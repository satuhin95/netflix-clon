...
import { removeLikedMovie } from '../store/store';
 const Card =({movieData,isLiked= false})=> {
  ...
  return (
    <Container onMouseEnter={()=>setIsHovered(true)} onMouseLeave={()=>setIsHovered(false)}>
      <img src={`https://image.tmdb.org/t/p/w500${movieData.image}`} alt="image" />
      {isHovered && (
        <div className='hover'>
            ...
            <div className="info-container flex column">
                ...
                <div className="icons flex j-between">
                    <div className="controls flex">
                        <IoPauseCircleSharp title='Play' onClick={()=>navigate('/player')} />
                        <RiThumbUpFill title='Like'/>
                        <RiThumbDownFill title='Dislike' />
                        {
                            isLiked? <BsCheck title='Remove From List' onClick={()=>dispatch(removeLikedMovie({movieId:movieData.id,email}))}/>:
